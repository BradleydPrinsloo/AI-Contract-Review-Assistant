...
- **Safe sample:** A minimal, non-confidential example when needed

## Future contribution workflow

If public contributions are enabled later, changes will use feature branches, focused commits, automated tests, documentation updates, and pull-request review before merging.
