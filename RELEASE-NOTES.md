...
- Added the Phase 2 Playbook foundation with SQLite-backed playbook CRUD, audit history, risk tolerance, status, Clause Library standard assignments, checklist items, and a professional PySide6 editor page.
